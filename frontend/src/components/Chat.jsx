...
export default function Chat({ token, loadedMessages = null, selectedChatId = null, onSaveCurrentChat = null, onSaveExistingChat = null, sessionId: externalSessionId = null, externalMessage = null, externalMessageId = null, phase = null }) {
  ...
  const detectCtas = (raw) => {
    try {
      ...
      // A complete proposal has: Metodología, Equipo, Fases, Presupuesto
  ...
  useEffect(() => {
    ...
    setMessages([{ role: 'assistant', content: '👋 Hola, soy el asistente de propuestas. Si eres principiante y quieres profundizar más en las metodologías de consultoría estratégica, puedes ir a la sección de "Aprender", o directamente escribe tu propuesta.\n\n📋 Recomendaciones de uso importantes:\nLa plataforma ha sido diseñada para ser muy intuitiva. ✨ Simplemente sigue las indicaciones y pulsa los botones que aparecerán en cada paso para avanzar de forma guiada en la configuración de tu proyecto.\n\n⚠️ IMPORTANTE: Antes de comenzar a escribir tu propuesta, registra tus empleados en la sección de empleados.\n\n⚠️ Es importante que utilices los botones de "Aceptar propuesta" (cuando ya hayas hecho todos los cambios pertinentes) ✅ o "Terminar proyecto" ✅ cuando aparezcan, ya que estos te permitirán avanzar correctamente a las siguientes fases del proceso.\n\n🎯 GUÍA INICIAL RECOMENDADA 🎯\n💡 Si es tu primera vez usando la plataforma, te recomendamos leer la guía rápida de uso. Pulsa el botón "¿Cómo generar una propuesta?" que aparece abajo para comenzar.', ts: new Date().toISOString() }])
            ...
            {messages.map((m, i) => (
              <div key={i} className={`box-border max-w-full md:max-w-[60%] break-words rounded-2xl px-3 py-2 shadow-sm ${m.role === 'user' ? 'ml-auto bg-blue-600 text-white' : 'bg-white border'}`}>
                ...
                {m.role === 'assistant' && (() => {
                      ...
                      <div className="mt-2 flex flex-col gap-2">
                        <div className="flex flex-wrap gap-2">
                          ...
                          <button
                            ...
                            onClick={() => {
                              setMessages(prev => [...prev, { role: 'assistant', content: '🏷️ Categorías y sectores soportados:\n\nEl sistema puede generar propuestas para proyectos en cualquiera de estas industrias:\n\n💰 Finanzas y Seguros:\n• Fintech: Banca digital, neobancos, plataformas de trading, exchanges de criptomonedas, wallets digitales, préstamos P2P, robo-advisors\n• InsurTech: Seguros digitales, comparadores de seguros, gestión automatizada de siniestros, cálculos actuariales, plataformas de corretaje\n• Payments: Pasarelas de pago (Stripe, PayPal), procesamiento de tarjetas, split payments, sistemas PCI-DSS, prevención de fraude\n\n🏥 Salud y Farmacia:\n• HealthTech: Telemedicina, videoconsultas médicas, historiales clínicos electrónicos (EHR/EMR), portales de pacientes, cumplimiento HIPAA\n• Farmacia: Gestión farmacéutica, recetas electrónicas, trazabilidad lote-serie, control de estupefacientes, farmacovigilancia, cumplimiento FDA/EMA/GMP\n• Dispositivos médicos: Wearables de salud, monitorización remota de pacientes, apps de diagnóstico, integración con dispositivos IoT\n\n🏭 Industria y Manufactura:\n• Manufactura/Industria 4.0: Sistemas MES (Manufacturing Execution System), control de producción en tiempo real, gestión de calidad (QMS), trazabilidad de lotes, integración con sensores IoT y PLCs, sistemas SCADA, mantenimiento predictivo\n• Energía: Smart grids (redes eléctricas inteligentes), gestión de subestaciones, predicción de demanda, sistemas SCADA, monitorización de infraestructura crítica, utilities, gestión de recursos renovables\n• Automoción: Connected car, diagnóstico remoto OBD-II, telemática vehicular, sistemas embebidos, actualizaciones OTA, V2X (vehicle-to-everything), seguridad funcional ISO 26262\n• Construcción: BIM (Building Information Modeling), gestión de proyectos de construcción, seguimiento de obras, control de materiales, asignación de cuadrillas, reportes de avance\n\n🛍️ Retail y E-commerce:\n• E-commerce: Tiendas online, marketplaces multi-vendedor, catálogos de productos, gestión de variantes (tallas, colores), carrito de compra, checkout optimizado\n• Retail omnicanal: Sistemas POS (punto de venta), gestión de inventario multi-almacén, stock en tiempo real, sincronización online/offline, Click & Collect\n• Fashion: Plataformas de moda, gestión de colecciones por temporada, lookbooks digitales, tallas y fit predictivo, recomendaciones de estilo\n\n📱 Tecnología y Entretenimiento:\n• Gaming: Videojuegos mobile/web/consola, sistemas multijugador, matchmaking, monetización (IAP, ads, battle pass), leaderboards, eventos en vivo, game analytics\n• Media y Streaming: Plataformas de streaming de video/audio, VOD (Video on Demand), live streaming, CDN global, transcodificación de video, DRM, recomendaciones con ML\n• Social Networks: Redes sociales, feeds personalizados, mensajería en tiempo real, sistema de likes/comentarios/shares, notificaciones push, moderación de contenido\n\n📊 Marketing y Ventas:\n• Marketing Tech: Plataformas de automatización de marketing, email marketing, SMS campaigns, A/B testing, segmentación de audiencias, analytics en tiempo real, integración con Google/Facebook Ads, attribution modeling\n• CRM: Gestión de relaciones con clientes, pipeline de ventas, lead scoring, automatización de ventas, reportes de conversión\n• Consumer Apps: Aplicaciones de consumo masivo, onboarding optimizado, engagement de usuarios, notificaciones push, programas de fidelización, feedback de usuarios\n\n🚚 Logística y Movilidad:\n• Logística y supply chain: Gestión de almacenes (WMS), tracking de flotas en tiempo real, optimización de rutas con ML, gestión de inventarios, POD digital, cross-docking\n• Food Delivery: Plataformas de delivery de comida, asignación dinámica de repartidores, tracking GPS en tiempo real, gestión de pedidos, integración con restaurantes, pagos digitales\n• Travel y turismo: Plataformas de reservas (vuelos, hoteles, tours), búsqueda avanzada, paquetes combinados, gestión de itinerarios, pagos multi-moneda, recomendaciones personalizadas\n\n🎓 Educación y Recursos Humanos:\n• EdTech: Plataformas e-learning, LMS (Learning Management Systems), cursos en video, evaluaciones interactivas, gamificación educativa, certificados digitales, foros de estudiantes, analytics de progreso\n• HR Tech: Sistemas ATS (Applicant Tracking System), gestión de talento, evaluaciones de desempeño, planes de formación, gestión de nóminas, portal del empleado, analytics de RRHH\n\n⚖️ Legal y Compliance:\n• LegalTech: Gestión de contratos legales, firma electrónica, repositorio documental, versionado automático, alertas de vencimientos, análisis de cláusulas con NLP, cumplimiento GDPR\n• Real Estate (PropTech): Marketplaces inmobiliarios, búsqueda avanzada de propiedades, tours virtuales 360°, calculadora de hipotecas, CRM para agentes inmobiliarios, gestión de citas\n\n🌾 Agricultura y Otros:\n• AgriTech: Agricultura de precisión, monitoreo IoT de cultivos, análisis con drones, predicción de cosechas con ML, gestión de riego automatizada, trazabilidad alimentaria\n• Sports & Fitness: Apps deportivas, planes de entrenamiento personalizados, tracking de ejercicios, integración con wearables, comunidad social, retos y gamificación, análisis de biometría\n• IoT: Sistemas de Internet of Things, edge computing, gestión de dispositivos conectados, telemetría, firmware OTA, protocolos MQTT/CoAP\n\n💡 Nota: Para cada categoría, el sistema ajusta automáticamente:\n- Metodología más adecuada (Scrum, Kanban, XP, SAFe, FDD, Lean, etc.)\n- Roles especializados necesarios (QA, Security, Compliance, ML Engineers, IoT Engineers, etc.)\n- Presupuesto según complejidad del sector (multiplicadores de tarifas por industria)\n- Duración estimada del proyecto (ajustes por regulación y criticidad)\n- Riesgos y controles específicos del dominio\n- Normativas y estándares aplicables (PCI-DSS, HIPAA, GDPR, ISO, FDA, etc.)', ts: new Date().toISOString() }])
                            }}
                          >
                          ...
                          <button
                            ...
                            onClick={() => {
                              setMessages(prev => [...prev, { role: 'assistant', content: '💡 Ejemplos de prompts para generar propuestas:\n\nAquí tienes ejemplos de descripción de proyectos que puedes usar como guía:\n\n🎮 GAMING:\n"Necesito desarrollar un videojuego mobile multijugador con sistema de progresión, monetización por compras in-app y eventos semanales. Queremos lanzar MVP en 4 meses."\n\n🏭 MANUFACTURA:\n"Crear un sistema MES (Manufacturing Execution System) para 5 plantas industriales con control de producción en tiempo real, trazabilidad completa, integración con sensores IoT y cumplimiento ISO 9001."\n\n👗 FASHION E-COMMERCE:\n"Plataforma ecommerce de moda con catálogo de 10,000 productos, gestión de colecciones por temporada, tallas/variantes, lookbook, recomendaciones personalizadas y marketplace para diseñadores."\n\n🏗️ CONSTRUCCIÓN:\n"Sistema de gestión de proyectos de construcción con seguimiento de obras, asignación de cuadrillas, control de materiales, reportes de avance diarios y alertas de desviaciones."\n\n💊 PHARMA:\n"Software de gestión farmacéutica para cadena de 50 farmacias con trazabilidad lote-serie, recetas médicas electrónicas, control de estupefacientes, cumplimiento FDA/EMA y reportes regulatorios."\n\n📊 MARKETING:\n"Plataforma de marketing automation con A/B testing, segmentación de audiencias, workflows de email/SMS, analytics en tiempo real, integraciones con Google/Facebook Ads."\n\n⚡ ENERGÍA:\n"Sistema de gestión de red eléctrica inteligente (smart grid) para distribuidora con monitoreo de subestaciones, predicción de demanda con ML, gestión de incidencias y cumplimiento regulatorio del sector."\n\n🏃 FITNESS:\n"App móvil de fitness con planes personalizados, tracking de ejercicios, integración con wearables, comunidad social, retos semanales y gamificación. MVP en 3 meses."\n\n🍔 FOOD DELIVERY:\n"Plataforma de delivery de comida con gestión de pedidos en tiempo real, asignación dinámica de repartidores, tracking GPS, múltiples restaurantes y pagos integrados."\n\n🛒 RETAIL:\n"Sistema omnicanal retail con POS para tiendas físicas, ecommerce, gestión de inventario multialmacén, CRM con programa de lealtad, analytics de ventas y integración con ERPs."\n\n💳 FINTECH:\n"Plataforma de banca digital con cuentas corrientes, tarjetas virtuales, transferencias internacionales, cumplimiento PCI-DSS, prevención de fraude con ML y reportes regulatorios automáticos."\n\n🏥 HEALTHTECH:\n"App de telemedicina con videoconsultas, historial médico electrónico, recetas digitales, integración con laboratorios, cumplimiento HIPAA y notificaciones push."\n\n💡 Tip: Simplemente copia uno de estos ejemplos, pégalo en el chat, y el sistema generará automáticamente una propuesta completa con metodología, equipo, presupuesto, fases y riesgos.', ts: new Date().toISOString() }])
                            }}
                          >
                            📝 Ver ejemplos de propuestas
                          </button>
                        </div>
                      </div>
                    )
                  ...
                  // Special case: "Mejores prácticas" message - show categories and examples buttons
                  const isBestPracticesMsg = typeof m.content === 'string' && m.content.includes('📝 Mejores prácticas para describir su proyecto')
                  ...
                  // Special case: "Categorías" message - show examples and best practices buttons  
                  const isCategoriesMsg = typeof m.content === 'string' && m.content.includes('🏷️ Categorías y sectores soportados')
                  ...
                  const isExamplesMsg = typeof m.content === 'string' && m.content.includes('💡 Ejemplos de prompts para generar propuestas')
